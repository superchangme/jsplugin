...
if(defined('ENV') && ENV=='production')
{
	...
	//mysqli_select_db("bfd", $conn);
	 $mysqli=new mysqli("localhost","root","abc123","yadi");
}
else
{
...
function saveData($action='visit')
{
	global $mysqli;
	$sql="insert into ".TABLE_PREFIX."data(`id`,`openid`,`date_add`,`action`) values(null,'".session_id()."',now(),'".$action."')";
	if (!$mysqli->query($sql))
	{
