...
/*		$(".btn-see-more-rank").on("click",function(){
    ...
    fetchScore:function(){
        ...
        $.ajax({
            ...
            success:function(data){
                if(data.result==1){
                    Game.$scoreDom.each(function(index,item){
                        var $data=$(this).data("score");
                        if($data=="total"){
                            $(this).text(data.total)
                        }else{
                            $(this).text(data[Game.gameBox[$data].gameName])
                        }
                    })
                }
            }
   ...
   init:function(){
    ...
    updateScreen:function(newScreen,choose){
        ...
        if(app.currentScreen){
            ...
            app.currentScreen.removeClass("  current");
        ...
        setTimeout(function(){
            ...
            app.pageLock=false;
            if(app.currentScreen){
                app.currentScreen.removeClass('in out up down')
            }
