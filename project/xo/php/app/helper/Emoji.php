...
class Emoji
{
    ...
    public $imageType = 'png'; //svg or png
    public $cacheBustParam = '?v=1.2.4';
    public $sprites = false; //true or false
    public $imagePathPNG = '/emoji-assests/png/';
    public $imagePathSVG = '/emoji-assests/svg/';
    public $imagePathSVGSprites = '/emoji-assests/sprites/emojione.sprites.svg';
    ...
    {
        $this->imagePathPNG=$app->config('baseUrl').$this->imagePathPNG;
        $this->imagePathSVG=$app->config('baseUrl').$this->imagePathSVG;
        $this->imagePathSVGSprites=$app->config('baseUrl').$this->imagePathSVGSprites;
    }
    public function emoji($opt=array())
    {
    	if(!empty($opt))
    	{
    	...
    	if($this->imageType=='png' && $this->sprites)
    	{
    		//$this->view->headLink()->appendStylesheet($this->view->baseUrl("/emoji-assests/css/emojione.min.css"));
    	}


    	//echo $this->imagePathSVGSprites;exit;
    	return $this;
    }
    
    public function processWechatMapping($str)
    {
    	return str_replace(array_values($this->unify_to_softbank),array_keys($this->unify_to_softbank),$str);
    }
    
	public function toImage($string)
    {
    	$string=$this->processWechatMapping($string);
    ...
    public function shortnameToUnicode($string)
    {
        ...
        if($this->ascii)
        {
            $asciiRegexp = $this->getAsciiRegexp();
    ...
    public function shortnameToAsciiCallback($m)
    {
        ...
        {
            $shortcode_replace = $this->getShortcodeReplace();
            $ascii_replace = $this->getAsciiReplace();
    ...
    public function shortnameToUnicodeCallback($m)
    {
        ...
        {
            $unicode_replace = $this->getUnicodeReplace();
    ...
    protected $unify_to_softbank=array(
